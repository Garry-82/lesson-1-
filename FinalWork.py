grades=[[5,4,4,3,5,5,5],[5,5,5,4,5,5],[3,5,5,4,5,4,5],[4,4,4,5,4,5],[3,3,3,2,3,3,4],[5,5,5,5,5,5,5]]
...
#how_mach_students=len(students)
# print(how_mach_students)
# a=0 #указатель на индекс ученика
#
# while a+1<how_mach_students:
#     if students[a+1]<students[a]:
#     str1=students[]
# else:
#     print('finish')
